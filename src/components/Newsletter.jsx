...
export function Newsletter() {
  ...
  const handleSubmit = async (e) => {
    ...
    formObject['target'] = 'Bitfiled Newsletter'

    try {
      setMessage('Sending...')
      const response = await fetch('https://www.solid-bit.com/api/email-13377331', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        setMessage('Your subscribed succesfully!')
